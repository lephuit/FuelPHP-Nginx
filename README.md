This is my test Nginx config to use with FuelPHP Framework that I am learning right now. Being not so good fan of Apache, everything .htaccess can do, Nginx does it better, this config proves it.
